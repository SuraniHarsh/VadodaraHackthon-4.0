...
const registerUser = async (req, res) => {
    try {
      ...
      const { username, email, password, role, first_name, last_name, interests, location, about_me, expertise } = req.body;
...
const getCurrentUser = asyncHandler(async(req,res) => {
    try {
        ...
        res.status(400).json({Error : "Current User", message : error.message});
    }
});
